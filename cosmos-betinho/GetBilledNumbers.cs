...
{
    public static class GetBilledNumbers
    {
        [FunctionName("GetBilledQuotas")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "get/numbers/billed/{limit:int}")] HttpRequest req,
